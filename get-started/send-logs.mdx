...
By default, the logs are being send async. You can confifure it to sync and also add additional variables to configure retries, delay, and much more.

```bash
NAVIGATOR_ASYNC             = FALSE
